...
<section class="section section-tight">
	<div class="container">
		<div class="cta-banner reveal">
			...
			<a href="<?php echo esc_url( bl_link_url( $data['destination'] ?? '' ) ); ?>" class="btn btn-primary"><?php echo bl_text( $data['btn_btn_primary'] ?? '' ); ?><?php bl_icon( $data['icon'] ?? '', $data['icon_image'] ?? 0 ); ?></a>
		</div>
	</div>
</section>
